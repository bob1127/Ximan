...
const servicesData = {
  ...
  sourcing: {
    title: "代購服務 Sourcing",
    desc: "找不到的款式，我們幫你找到。協助您媒合當季新品、限量款、熱門款與收藏級商品。",
...
export default function Services() {
  ...
  const structuredData = {
    ...
    "@type": "Service",
    serviceType: "Luxury Goods Services",
    provider: {
      "@type": "Organization",
      name: "KÉSH de¹ 凱仕國際精品",
      url: "https://www.keshde1.com", // Replace with your actual URL
    },
    areaServed: "Taiwan",
    hasOfferCatalog: {
      "@type": "OfferCatalog",
      ...
      itemListElement: [
        {
          ...
          itemOffered: {
            "@type": "Service",
            name: "Luxury Bag Buy-in (收購)",
            description: "Instant cash for luxury bags with professional appraisal.",
          },
        },
        {
          "@type": "Offer",
          itemOffered: {
            "@type": "Service",
            name: "Luxury Consignment (寄賣)",
            description: "Professional consignment service with 20% commission fee.",
          },
        },
        {
          "@type": "Offer",
          itemOffered: {
            "@type": "Service",
            name: "Luxury Trade-in (置換)",
            description: "Trade in your old luxury items for new ones at our store.",
          },
        },
        {
          "@type": "Offer",
          itemOffered: {
            "@type": "Service",
            name: "Luxury Sourcing (代購)",
            description: "Global sourcing for specific luxury items and new arrivals.",
          },
        },
      ],
    },
  ...
  const faqData = {
    ...
    "@type": "FAQPage",
    mainEntity: [
      ...servicesData["buy-in"].faq.map((f) => ({
        "@type": "Question",
        name: f.q,
        acceptedAnswer: { "@type": "Answer", text: f.a },
      })),
      ...servicesData["consignment"].faq.map((f) => ({
        "@type": "Question",
        name: f.q,
        acceptedAnswer: { "@type": "Answer", text: f.a },
      })),
  ...
  return (
    <ReactLenis root>
      <Head>
        <title>服務流程 | KÉSH de¹ 凱仕國際精品 - 收購、寄賣、置換、代購</title>
        <meta
          name="description"
          content="KÉSH de¹ 提供全方位精品服務：高價收購、專業寄賣、以舊換新置換服務，以及全球專櫃新品代購。專業鑑定，正品保證。"
        />
        <script
