...
// --- 各服務詳細資料 (Data remains the same) ---
const servicesData = {
  "buy-in": {
    title: "收購流程 Buy-in",
    desc: "最快速的變現方式。我們提供具競爭力的市場報價，現場確認無誤即刻撥款。",
    steps: [
      { step: "01", title: "初步估價", desc: "透過 LINE 線上傳送照片，或直接攜帶商品至門市。" },
      { step: "02", title: "實品鑑定", desc: "專業鑑定師現場確認包況、配件與真偽。" },
      { step: "03", title: "簽署合約", desc: "雙方確認價格與物品狀況，簽署買賣讓渡書。" },
      { step: "04", title: "現金撥款", desc: "完成手續，立即現金支付或匯款轉帳。" },
    ],
    pricing: "依據品牌、款式熱門度、當前二手市場行情及商品實際保存狀況（年份、磨損、配件完整度）進行綜合鑑價。",
    faq: [
      { q: "收購價格與寄賣價格有差嗎？", a: "有的。收購由店方承擔庫存風險，價格通常會略低於寄賣；優點是能立即拿到現金，不需等待銷售期。" },
      { q: "沒有購買證明可以收購嗎？", a: "可以。但部分特定品牌或款式（如 Chanel 雷標款、Hermes）若無配件可能會影響收購價格，建議盡量附上。" },
    ],
  },
  consignment: {
    ...
    steps: [
      { step: "01", title: "制定售價", desc: "雙方討論並協議合理的上架販售金額。" },
      { step: "02", title: "簽署合約", desc: "確認寄賣期間（通常為 3-6 個月）與保管條款。" },
      { step: "03", title: "專業上架", desc: "商品清潔整理、專業攝影、官網與社群曝光。" },
      { step: "04", title: "售出撥款", desc: "商品售出後，扣除 20% 手續費，於約定時間內匯款給您。" },
    ],
    pricing: "我們會提供專業建議售價，但最終定價權在於您。若定價過高導致長期滯銷，我們會與您討論適度調整價格。",
    faq: [
      { q: "寄賣期間可以取回商品嗎？", a: "可以。若在合約期內取回，可能需支付少許整新保管費；合約期滿未售出則可免費取回。" },
      { q: "寄賣商品會被隨意觸摸嗎？", a: "不會。KÉSH de¹ 門市採預約制或嚴格控管，高單價商品皆展示於櫃內，僅由服務人員配戴手套展示。" },
    ],
  },
  "trade-in": {
    title: "置換流程 Trade-in",
    ...
    steps: [
      { step: "01", title: "挑選商品", desc: "在 KÉSH de¹ 挑選您想換購的目標商品。" },
      { step: "02", title: "舊包鑑價", desc: "我們評估您帶來的舊包價值（通常高於直接收購價）。" },
      { step: "03", title: "補足差額", desc: "計算「新包價格」減去「舊包抵價」，您僅需支付差額。" },
      { step: "04", title: "完成交換", desc: "一次完成出清與入手，享受升級樂趣。" },
    ],
    pricing: "置換服務通常能為您的舊包爭取到比「直接收購」更優惠的折抵價格，作為我們鼓勵循環時尚的回饋。",
    faq: [
      { q: "可以多個包換一個包嗎？", a: "可以。您可以使用多個閒置商品累計金額，來換購一個高單價商品。" },
      { q: "如果舊包價值高於新包怎麼辦？", a: "若舊包價值較高，我們會將差額以現金或匯款方式退還給您。" },
    ],
  },
  sourcing: {
    title: "代購服務 Sourcing",
    ...
    steps: [
      { step: "01", title: "需求確認", desc: "填寫代購表單，專人聯繫確認款式與細節。" },
      { step: "02", title: "報價與付款", desc: "提供正式報價與交期，確認後需支付 100% 全額款項。" },
      { step: "03", title: "全球採購", desc: "啟動國際專櫃與通路採購，全程回報進度。" },
      { step: "04", title: "鑑定出貨", desc: "到貨後經專業鑑定建檔，安排配送給您。" },
    ],
    formInfo: [
      "姓名 / 電話 / Email",
      "欲代購品牌 / 型號 / 顏色 / 尺寸",
    ...
    paymentPolicy: {
      title: "付款制度 (全額預付制)",
      content: "訂單成立後需一次性支付商品總金額 100%。KÉSH 所有代購訂單皆由第三方支付平台 Unipay 代為收款與管理金流，確保交易流程透明安全。",
    },
    refundPolicy: {
      title: "缺貨退款保障 (信任機制)",
      content: "若因專櫃缺貨、停產、官方下架等因素導致無法完成採購，KÉSH 將透過 Unipay 於 3-5 個工作天內全額退款 (含原支付金額)，不收取任何手續費。",
    },
    legalNote: "代購屬於「依消費者指定需求進行採購之客製化商品」，依《消費者保護法》第19條規定，不適用七日鑑賞期，訂單成立並付款後除缺貨外恕無法取消或退換貨。",
    shipping: "國際專櫃現貨約 7-14 工作天；歐洲通路約 14-21 工作天；特殊款依實際回覆為準。",
  },
};
...
export default function Services() {
  ...
  const pageTitle = "服務流程 Services | KÉSH de¹ 凱仕國際精品";
  const pageDesc = "KÉSH de¹ 凱仕國際精品提供全方位精品服務：高價收購二手精品、專業寄賣服務、以舊換新置換，以及全球專櫃代購。流程透明，100% 正品保證。";
      ...
      "itemListElement": [
        {
          ...
          "itemOffered": {
            "@type": "Service",
            "name": "精品收購 Buy-in",
            "description": "提供具競爭力的市場報價，現場確認無誤即刻撥款，最快速的變現方式。"
          }
        },
        {
          "@type": "Offer",
          "itemOffered": {
            ...
            // UPDATED: 使用您提供的完整寄賣文案
            "description": "協助您為閒置精品包款進行合理定價並上架寄賣。從合約簽訂、銷售到成交收款，流程透明清楚，讓精品在安心與信任中找到下一位收藏者。"
          }
        },
        {
          "@type": "Offer",
          "itemOffered": {
            "@type": "Service",
            "name": "以舊換新 Trade-in",
            "description": "用您手邊的閒置精品，折抵換購店內的心儀款式，讓收藏流動。"
          }
        },
        {
          "@type": "Offer",
          "itemOffered": {
            "@type": "Service",
            "name": "精品代購 Sourcing",
            // UPDATED: 使用您提供的完整代購文案
            "description": "提供專業精品代購與尋款服務，依照您的需求協助尋找合適款式，價格與等待時間清楚說明，確保每一次代購都安心無虞。"
          }
        }
      ]
    }
  ...
  return (
    <ReactLenis root>
      <Head>
        ...
        <meta name="keywords" content="精品收購, 二手包寄賣, 精品代購, 愛馬仕代購, 香奈兒收購, LV寄賣, 精品置換, KESH de1" />
        ...
        <div className="max-w-6xl mx-auto px-6">
            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-8 relative">
                ...
                {servicesData[activeTab].steps.map((step, index) => (
                  <div key={index} className="bg-white pt-0 md:pt-6 relative group">
              ...
              {activeTab === "sourcing" ? (
                ...
                <div className="space-y-12">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 bg-gray-50 p-8 md:p-12 rounded-sm">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-gray-600 space-y-2">
                        <p className="font-bold mb-2">請準備以下資料，我們將於 24 小時內聯繫：</p>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    ...
                    <div className="border border-gray-100 p-6">
                      <h4 className="font-bold text-black mb-3">缺貨退款保障</h4>
                      <p className="text-sm text-gray-500 leading-relaxed">
                    ...
                    <div className="border border-gray-100 p-6">
                      ...
                      <p className="text-sm text-gray-500 leading-relaxed mb-2">
                        <span className="font-bold text-xs bg-gray-100 px-1">法律</span> {servicesData.sourcing.legalNote}
                      </p>
                      <p className="text-sm text-gray-500 leading-relaxed">
                        <span className="font-bold text-xs bg-gray-100 px-1">交期</span> {servicesData.sourcing.shipping}
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="bg-gray-900 text-white p-6 md:p-8 rounded-sm text-center">
                    ...
                    <p className="text-sm md:text-base font-light leading-relaxed max-w-2xl mx-auto opacity-90">
                      KÉSH de¹ 僅協助代購來源透明、可驗證之正規商品，所有商品皆經專業鑑定師檢查，並建立完整商品履歷。我們不只是幫您買到一個包，而是替您完成一個重要的收藏決定。
                    </p>
                  </div>
                </div>
              ) : (
                ...
                <>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 bg-gray-50 p-8 md:p-12 rounded-sm">
                    ...
                    <div>
                      ...
                      <div className="mb-6">
                        <p className="text-sm text-gray-500 font-bold mb-2">需提供資料：</p>
                      ...
                      <div>
                        <p className="text-sm text-gray-500 font-bold mb-2">價格評估方式：</p>
                  ...
                  {servicesData[activeTab].faq && (
                    <div className="mt-16">
                      <h3 className="text-xl font-serif mb-8 text-center">FAQ 常見問答</h3>
                      <div className="grid md:grid-cols-2 gap-8">
                        {servicesData[activeTab].faq.map((item, idx) => (
                          <div key={idx} className="border border-gray-100 p-6 hover:shadow-sm transition-shadow">
          ...
          <div className="mt-20 text-center border-t border-gray-100 pt-16">
            <p className="text-gray-500 mb-6">
              {activeTab === "sourcing" ? "尋找夢幻逸品？立即聯繫我們" : "準備好開始了嗎？"}
            </p>
