...
export const SlideTabsExample = () => {
  ...
  const navLinks = [
    { label: "Clothes上衣", href: "/" },
    { label: "PRODUCTS", href: "/about" },
    { label: "PRODUCTS", href: "#" },
    { label: "PRODUCTS", href: "#" },
    { label: "PRODUCTS", href: "/charge" },
  ];
          ...
          <div className="hidden md:flex gap-6 items-center">
            {navLinks.map((link) => (
              <Link
                key={link.label}
                href={link.href}
                className="group  relative h-10 rounded-full bg-transparent px-4 text-neutral-950 flex items-center"
              >
                <span className="relative inline-flex overflow-hidden leading-[2.5rem]">
                  <div className="transform transition  duration-700 group-hover:-translate-y-full group-hover:skew-y-12">
                    {link.label}
                  </div>
                  <div className="absolute top-0 transform translate-y-full group-hover:translate-y-0 group-hover:skew-y-0 transition duration-700 text-slate-500 group-hover:text-black">
                    {link.label}
                  </div>
                </span>
              </Link>
